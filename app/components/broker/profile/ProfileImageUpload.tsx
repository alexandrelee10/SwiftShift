    ...
    <div className="mt-6 flex flex-col gap-6 sm:flex-row sm:items-center">
      ...
      <div>
        ...
        <button
          ...
          className="mt-3 rounded-lg border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-slate-100 dark:hover:"
        >
